...
import bgakad from '../../Img/cover-akad.webp'
import bgresepsi from '../../Img/cover-resepsi.webp'
  ...
  return (
    <>
      <div className='my-16'>
        ...
        <h1 className='text-center text-4xl font-semibold custom-font-3 mx-4 mb-16 text-[#413327]'>Waktu & Lokasi <br /> Acara</h1>
        <div className='flex justify-center mb-8 mx-4'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-16'>
            <div className='rounded-2xl relative bg-akad' style={{ backgroundImage: `url(${bgakad})` }}>
            ...
            <div className='rounded-2xl relative bg-resepsi' style={{ backgroundImage: `url(${bgresepsi})` }}>
              <div className='absolute rounded-2xl w-full h-full bg-black/50'></div>
              <div className='relative py-16 px-8'>
                <center>
        ...
        <center>
          <div className='max-w-4xl mx-6 rounded-xl'>
